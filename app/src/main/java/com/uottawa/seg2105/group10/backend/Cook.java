...
public class Cook extends User{
	...
	public void createMeal(String name, float price, String descr, String type, ArrayList<String> cuisine, HashMap<String, String> ingredients, HashMap<String, String> allergens) {
